...
// Set Variables
$LOCAL_ROOT         = "/var/www/html/cab230";
$LOCAL_REPO_NAME    = "auto_site";
$LOCAL_REPO         = "{$LOCAL_ROOT}/{$LOCAL_REPO_NAME}";
$REMOTE_REPO        = "git@bitbucket.org:mharv4/cab230-assignment.git";
$BRANCH             = "master";
  ...
  if( file_exists($LOCAL_REPO) ) {
    ...
    //$log = shell_exec("cd {$LOCAL_REPO} && git remote show origin");
    $log = shell_exec("cd {$LOCAL_REPO} && git pull");
	echo ($log);
    die("done " . mktime());
  }
