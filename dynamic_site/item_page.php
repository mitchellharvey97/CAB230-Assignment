...
//echo $recieved_data->Suburb;

		$wifiName = $recieved_data->{'Wifi Hotspot Name'};
		$wifiAddress = $recieved_data->{'Address'};
		$wifiSuburb =$recieved_data->{'Suburb'};
		$wifiLat  = $recieved_data->{'Latitude'};
		$wifiLng  = $recieved_data->{'Longitude'};
